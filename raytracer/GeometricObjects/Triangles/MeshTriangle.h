...
class MeshTriangle: public GeometricObject {	
    public:
        ...
        Normal		normal;					
        double		area;				// required for translucency
    ...
    protected:
        ...
        double interpolate_u(const double beta, const double gamma) const;

        double interpolate_v(const double beta, const double gamma) const;			
};
