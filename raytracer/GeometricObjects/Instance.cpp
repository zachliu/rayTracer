...
void Instance::rotate_x(const double theta) {
	...
	double sin_theta = std::sin(theta * PI_ON_180);
	double cos_theta = std::cos(theta * PI_ON_180);
...
void Instance::rotate_y(const double theta) {
	...
	double sin_theta = std::sin(theta * PI / 180.0);
	double cos_theta = std::cos(theta * PI / 180.0);
