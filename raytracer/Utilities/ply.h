...
typedef struct PlyFile {        /* description of PLY file */
  ...
  double version;                /* version number of file */
...
extern PlyFile *ply_open_for_writing(char *, int, char **, int, double *);
...
extern PlyFile *ply_open_for_reading( char *, int *, char ***, int *, double *);
...
extern void ply_get_info(PlyFile *, double *, int *);
