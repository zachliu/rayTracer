...
void World::build(void) {
                ...
                if ( line.compare( 0, 1, "C" ) == 0 ) {
                    ...
                    switch ( (int)dataC[14] ) {
                        case 0:		
                            ...
                            TIFFSetField( outfile_int, TIFFTAG_IMAGEWIDTH, (uint32) vp.hres );
                            TIFFSetField( outfile_int, TIFFTAG_IMAGELENGTH, (uint32) vp.vres );
    ...
    TIFFSetField( outfile, TIFFTAG_IMAGEWIDTH, (uint32) vp.hres );
    TIFFSetField( outfile, TIFFTAG_IMAGELENGTH, (uint32) vp.vres );
