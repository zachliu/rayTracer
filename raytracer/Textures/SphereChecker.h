...
class SphereChecker: public Texture {		
	public:
		...
		void													
		set_horizontal_line_width(const double width);
		
		void													
		set_vertical_line_width(const double width);
								
		void																	
		set_color1(const double r, const double g, const double b);
		
		void																
		set_color1(const double c);	
		
		void																
		set_color1(const RGBColor& c);
		
		void																	
		set_color2(const double r, const double g, const double b);
		
		void																
		set_color2(const double c);	
		
		void																
		set_color2(const RGBColor& c);									
		
		void																	
		set_line_color(const double r, const double g, const double b); 
		
		void																	
		set_line_color(const double c);
	...
	private:
		...
		double		horizontal_line_width;		// width of the horizontal lines as a fraction of the checker width
		double		vertical_line_width;		// width of the vertical lines as a fraction of the checker width
...
inline void													
SphereChecker::set_horizontal_line_width(const double width) {
	horizontal_line_width = width;
}

inline void													
SphereChecker::set_vertical_line_width(const double width) {
	vertical_line_width = width;
}
		
inline void																	
SphereChecker::set_color1(const double r, const double g, const double b) {
	color1.r = r; color1.g = g; color1.b = b;
}

inline void																
SphereChecker::set_color1(const double c) {
...
inline void																	
SphereChecker::set_color2(const double r, const double g, const double b) {
	color2.r = r; color2.g = g; color2.b = b;
}

inline void																
SphereChecker::set_color2(const double c) {
...
inline void																	
SphereChecker::set_line_color(const double r, const double g, const double b) {
	line_color.r = r; line_color.g = g; line_color.b = b;
}

inline void																	
SphereChecker::set_line_color(const double c) {
